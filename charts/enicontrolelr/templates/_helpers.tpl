...
{{/*
Expand the name of enipam .
*/}}
{{- define "enipam.name" -}}
{{- default "enipam" .Values.global.nameOverride | trunc 63 | trimSuffix "-" }}
{{- end }}

{{/*
Common labels
*/}}
{{- define "enipam.Controller.labels" -}}
helm.sh/chart: {{ include "enipam.chart" . }}
{{ include "enipam.Controller.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "enipam.Controller.selectorLabels" -}}
app.kubernetes.io/name: {{ include "enipam.name" . }}
...
*/}}
{{- define "enipam.Controller.image" -}}
...
{{- define "generate-ca-certs" }}
    {{- $ca := genCA "eni.io" (.Values.controller.tls.auto.caExpiration | int) -}}
    {{- $_ := set . "ca" $ca -}}
{{- end }}
